...
-- Email templates and new column for membership search and renewal
INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, enabled, active, topic, content, content_lines, joinfiles) VALUES (0, 'adherent','member','',0,null,null,'(SendingAnEMailToMemberEMailSearchFound)',   65,'$conf->adherent->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(NewMembershipRequestReceived)__',                     '__(Hello)__,<br><br>\n\n__(ThisIsContentOfEMailSearchBody)__<br><br>\n\n__(ThisIsContentOfEMailSearchFound)__<br>\n(MembershipRenewalURL)<br><br>\n\n__(ThisIsContentOfEMailSearchNotFound)__<br>\n(NewMembershipURL)<br><br>\n\n__(Sincerely)__,<br>__(TeamSignature)__',null, 0);
INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, enabled, active, topic, content, content_lines, joinfiles) VALUES (0, 'adherent','member','',0,null,null,'(SendingAnEMailToMemberEMailSearchNotFound)',66,'$conf->adherent->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(NewMembershipRequestReceived)__',                     '__(Hello)__,<br><br>\n\n__(ThisIsContentOfEMailSearchBody)__<br><br>\n\n__(ThisIsContentOfEMailSearchNotFound)__<br>\n(NewMembershipURL)<br><br>\n\n__(Sincerely)__,<br>__(TeamSignature)__',null, 0);
ALTER TABLE `llx_adherent` ADD `urltoken` VARCHAR(32) NULL DEFAULT NULL COMMENT 'URL token for information change or membership renewal' AFTER `gender`; 
ALTER TABLE `llx_adherent` ADD `urltokenexpiringdate` DATE NULL DEFAULT NULL COMMENT 'Expiring date for field urltoken' AFTER `urltoken`; 
